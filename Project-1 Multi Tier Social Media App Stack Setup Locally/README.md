...
- In Project-1, I have setup 3-Tier Social Media Application manually.
-At First i will execute below command in my computer to install hostmanager plugin
```sh
...
```
 ...
 This time I will create bash scripts to automate VM creation/provisioning through Vagrantfile.

- First I will create `mysql.sh` file for our database.
```sh
#!/bin/bash
